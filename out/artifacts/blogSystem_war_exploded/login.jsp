			...
			<div class="login sign-up-htm">
				<form action="<%=basePath %>/UserRegister" method="get" class="container offset1 loginform">
					...
					<div class="pad input-container">
						<section class="content">
						<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" name="nickname" id="register-nickname" 
									autocomplete="off" placeholder="请输入昵称" maxlength="15"/>
								<label class="input__label input__label--hideo" for="register-nickname">
									<i class="fa fa-fw fa-user icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
							</span>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="register-repassword" name="repassword" placeholder="请确认密码" maxlength="15"/>
							...
							<span class="input input--hideo">
								<select class="input__field input__field--hideo" name="gender" id="register-gender" autocomplete="off" placeholder="请输入性别"/>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-email"  name="email" autocomplete="off" placeholder="请输入邮箱"/>
								<label class="input__label input__label--hideo" for="register-code">
									<i class="fa fa-fw fa-wifi icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
